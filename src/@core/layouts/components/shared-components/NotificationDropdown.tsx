        ...
        <ScrollWrapper>
          <MenuItem onClick={handleDropdownClose}>
            <Box sx={{ width: '100%', display: 'flex', alignItems: 'center' }}>
              <Avatar alt='Flora' src={`${process.env.NEXT_PUBLIC_BASE_URL}/images/avatars/4.png`} />
          ...
          <MenuItem onClick={handleDropdownClose}>
            <Box sx={{ width: '100%', display: 'flex', alignItems: 'center' }}>
              <Avatar alt='message' src={`${process.env.NEXT_PUBLIC_BASE_URL}/images/avatars/5.png`} />
              <Box sx={{ mx: 4, flex: '1 1', display: 'flex', overflow: 'hidden', flexDirection: 'column' }}>
          ...
          <MenuItem onClick={handleDropdownClose}>
            <Box sx={{ width: '100%', display: 'flex', alignItems: 'center' }}>
              <img
                ...
                height={38}
                alt='paypal'
                src={`${process.env.NEXT_PUBLIC_BASE_URL}/images/misc/paypal.png`}
              />
              <Box sx={{ mx: 4, flex: '1 1', display: 'flex', overflow: 'hidden', flexDirection: 'column' }}>
          ...
          <MenuItem onClick={handleDropdownClose}>
            <Box sx={{ width: '100%', display: 'flex', alignItems: 'center' }}>
              <Avatar alt='order' src={`${process.env.NEXT_PUBLIC_BASE_URL}/images/avatars/3.png`} />
              <Box sx={{ mx: 4, flex: '1 1', display: 'flex', overflow: 'hidden', flexDirection: 'column' }}>
          ...
          <MenuItem onClick={handleDropdownClose}>
            <Box sx={{ width: '100%', display: 'flex', alignItems: 'center' }}>
              <img
                ...
                height={38}
                alt='chart'
                src={`${process.env.NEXT_PUBLIC_BASE_URL}/images/misc/chart.png`}
              />
              <Box sx={{ mx: 4, flex: '1 1', display: 'flex', overflow: 'hidden', flexDirection: 'column' }}>
