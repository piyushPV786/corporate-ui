...
export const transformDropDownData = (options: any[], labelMapKey = 'name', valuMapKey = 'code') => {
  return options?.map(item => ({ label: item[labelMapKey], value: item[valuMapKey], ...item }))
}
