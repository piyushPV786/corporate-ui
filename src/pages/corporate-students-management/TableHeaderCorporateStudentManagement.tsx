...
const TableHeaderCorporateStudentManagement = (props: TableHeaderProps) => {
  // ** Props
        ...
        <Box>
          <Box sx={{ display: 'flex' }}>
            ...
            <FullPermission featureCode={FeatureCodes.EMS.studentManagement}>
              <Box sx={{ border: '1px solid #9E9E9E', mr: 2, display: 'none' }}></Box>
              <Box>
...
export default TableHeaderCorporateStudentManagement
