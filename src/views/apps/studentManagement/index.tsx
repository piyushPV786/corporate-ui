...
import { IEnrollState } from 'src/context/common'

interface IEnrollAndUnenrollStudentListProps {
  EnrolledStudent: IEnrollState
  handleClose: () => void
}

const EnrollAndUnenrollStudentList = ({ EnrolledStudent, handleClose }: IEnrollAndUnenrollStudentListProps) => {
...
export default EnrollAndUnenrollStudentList
