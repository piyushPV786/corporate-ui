    ...
    <Fragment>
          ...
          >
            <Box sx={{ display: 'flex', alignItems: 'center' }}>
              <img
                ...
                height='35'
                alt='Google'
                src={`${process.env.NEXT_PUBLIC_BASE_URL}/images/logos/google.png`}
              />
              <Box sx={{ ml: 4 }}>
          ...
          <Box sx={{ display: 'flex', mb: 7, alignItems: 'center', justifyContent: 'space-between' }}>
            <Box sx={{ display: 'flex', alignItems: 'center' }}>
              <img
                ...
                height='35'
                alt='Slack'
                src={`${process.env.NEXT_PUBLIC_BASE_URL}/images/logos/slack.png`}
              />
              <Box sx={{ ml: 4 }}>
          ...
          <Box sx={{ display: 'flex', mb: 7, alignItems: 'center', justifyContent: 'space-between' }}>
            <Box sx={{ display: 'flex', alignItems: 'center' }}>
              <img
                ...
                height='35'
                alt='Github'
                src={`${process.env.NEXT_PUBLIC_BASE_URL}/images/logos/github.png`}
              />
              <Box sx={{ ml: 4 }}>
          ...
          <Box sx={{ display: 'flex', mb: 7, alignItems: 'center', justifyContent: 'space-between' }}>
            <Box sx={{ display: 'flex', alignItems: 'center' }}>
              <img
                ...
                height='35'
                alt='Mailchimp'
                src={`${process.env.NEXT_PUBLIC_BASE_URL}/images/logos/mail-chimp.png`}
              />
              <Box sx={{ ml: 4 }}>
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            <Box sx={{ display: 'flex', alignItems: 'center' }}>
              <img
                ...
                height='35'
                alt='Asana'
                src={`${process.env.NEXT_PUBLIC_BASE_URL}/images/logos/asana.png`}
              />
              <Box sx={{ ml: 4 }}>
      ...
      <Card>
        ...
        <CardContent>
          ...
          >
            <Box sx={{ display: 'flex', alignItems: 'center' }}>
              <Img height='35' alt='Facebook' src={`${process.env.NEXT_PUBLIC_BASE_URL}/images/logos/facebook.png`} />
              <Box sx={{ ml: 4 }}>
          ...
          <Box sx={{ display: 'flex', mb: 6, alignItems: 'center', justifyContent: 'space-between' }}>
            <Box sx={{ display: 'flex', alignItems: 'center' }}>
              <Img
                ...
                height='35'
                alt='Twitter'
                src={`${process.env.NEXT_PUBLIC_BASE_URL}/images/logos/twitter.png`}
              />
              <Box sx={{ ml: 4 }}>
          ...
          <Box sx={{ display: 'flex', mb: 6, alignItems: 'center', justifyContent: 'space-between' }}>
            <Box sx={{ display: 'flex', alignItems: 'center' }}>
              <Img
                ...
                height='35'
                alt='LinkedIn'
                src={`${process.env.NEXT_PUBLIC_BASE_URL}/images/logos/linkedin.png`}
              />
              <Box sx={{ ml: 4 }}>
          ...
          <Box sx={{ display: 'flex', mb: 6, alignItems: 'center', justifyContent: 'space-between' }}>
            <Box sx={{ display: 'flex', alignItems: 'center' }}>
              <Img
                ...
                height='35'
                alt='Dribbble'
                src={`${process.env.NEXT_PUBLIC_BASE_URL}/images/logos/dribbble.png`}
              />
              <Box sx={{ ml: 4 }}>
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            <Box sx={{ display: 'flex', alignItems: 'center' }}>
              <Img
                ...
                height='35'
                alt='Behance'
                src={`${process.env.NEXT_PUBLIC_BASE_URL}/images/logos/behance.png`}
              />
              <Box sx={{ ml: 4 }}>
