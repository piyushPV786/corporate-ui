...
const projectListDate: ProjectListDataType[] = [
  {
    ...
    img: `${process.env.NEXT_PUBLIC_BASE_URL}/images/icons/project-icons/react.png`
  },
  {
    hours: '20:42',
    progressValue: 18,
    ...
    img: `${process.env.NEXT_PUBLIC_BASE_URL}/images/icons/project-icons/figma.png`
  },
  {
    hours: '120:87',
    progressValue: 62,
    ...
    img: `${process.env.NEXT_PUBLIC_BASE_URL}/images/icons/project-icons/vue.png`
  },
  {
    hours: '89:19',
    progressValue: 8,
    ...
    img: `${process.env.NEXT_PUBLIC_BASE_URL}/images/icons/project-icons/xamarin.png`
  },
  {
    hours: '230:10',
    progressValue: 49,
    ...
    img: `${process.env.NEXT_PUBLIC_BASE_URL}/images/icons/project-icons/python.png`
  },
  {
    hours: '342:41',
    progressValue: 92,
    ...
    img: `${process.env.NEXT_PUBLIC_BASE_URL}/images/icons/project-icons/sketch.png`
  },
  {
    hours: '12:45',
    progressValue: 88,
    ...
    img: `${process.env.NEXT_PUBLIC_BASE_URL}/images/icons/project-icons/html5.png`
  }
]
          ...
          <Timeline placeholder={undefined} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}>
              ...
              <TimelineContent>
                ...
                <Box sx={{ mt: 2, display: 'flex' }}>
                  <Box sx={{ width: 28, height: 'auto' }}>
                    <img
                      alt='invoice.pdf'
                      src={`${process.env.NEXT_PUBLIC_BASE_URL}/images/icons/file-icons/pdf-2.png`}
                    />
                  </Box>
            ...
            <TimelineItem>
              ...
              <TimelineContent>
                ...
                <Box sx={{ display: 'flex', alignItems: 'center' }}>
                  <AvatarGroup max={4}>
                    <Avatar src={`${process.env.NEXT_PUBLIC_BASE_URL}/images/avatars/1.png`} alt='John Doe' />
                    <Avatar src={`${process.env.NEXT_PUBLIC_BASE_URL}/images/avatars/4.png`} alt='Olivia Sparks' />
                    <Avatar src={`${process.env.NEXT_PUBLIC_BASE_URL}/images/avatars/5.png`} alt='Howard Lloyd' />
                    <Avatar src={`${process.env.NEXT_PUBLIC_BASE_URL}/images/avatars/6.png`} alt='Hallie Richards' />
                    <Avatar src={`${process.env.NEXT_PUBLIC_BASE_URL}/images/avatars/8.png`} alt='Alice Cobb' />
                    <Avatar src={`${process.env.NEXT_PUBLIC_BASE_URL}/images/avatars/7.png`} alt='Jeffery Warner' />
                  </AvatarGroup>
