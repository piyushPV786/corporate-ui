...
const validationSchema = Yup.object({
  ...
  duration: Yup.number().transform((value, originalValue) => (originalValue === '' ? undefined : value)).max(120, "Duration Cannot be more than 120 months").required("This Field is required"),
